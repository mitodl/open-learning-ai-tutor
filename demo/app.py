...
def generate_and_commit(g,repo):
    data_to_store = {
                ...
                "Messages": [{"turn":i,
                               ...
                               "extra_info": st.session_state['extra_info'][i] if len(st.session_state['extra_info'])>i else ""
                               } 
...
model_code_to_name = {"gpt-4o-mini": "GPT-4o-mini", "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo": "Llama-3.1_405B", "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo": "Llama-3.1_70B"}
model = None
...
######################################
    ...
    def get_user_name(name):
        ...
        inputname = st.text_input("Enter your name for the log")
        if st.button("Submit"):
