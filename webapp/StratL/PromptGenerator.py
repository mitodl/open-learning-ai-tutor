...
# Old version. We use SimplePromptGenerator instead.
...
class SimplePromptGenerator(PromptGenerator):
    def get_prompt(self,pb,sol,student_messages,tutor_messages,intents):
        system_msg  = \
        f"""Act as an experienced tutor. Your student is a college freshman majoring in math. Characteristics of a good tutor include:
    • Promote a sense of challenge, curiosity, feeling of control
