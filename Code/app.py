...
openai_key = "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"
anthropic_api_key = "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"
os.environ["ANTHROPIC_API_KEY"] = anthropic_api_key
os.environ["OPENAI_API_KEY"] = openai_key   
os.environ["E2B_API_KEY"]="e2b_b32f0bb0734955234f812472f267a1e64a3db9d9"
os.environ["TOGETHER_API_KEY"] = "314fa1ff7a22cef395fab4485fff646a5dce65e15aa182a9b75a9a660e7d04be"
...
# randomization
models_available = ["gpt-4o-mini", "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo", "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo"]
model_code_to_name = {"gpt-4o-mini": "GPT-4o-mini", "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo": "Llama-3.1", "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo": "Nemotron"}
model = None
...
#     st.session_state['current_model_name'] = "GPT-4o"
    ...
    with container:
        ...
        if submit_button and user_input:
            ...
            with response_container:
                with st.chat_message(name="ai",avatar=url_prof_image):
                    st.write("")
                    output, tutor_total_tokens, tutor_prompt_tokens, tutor_completion_tokens, intent, assessment = st.session_state['Tutor'].get_response(st.session_state['student'] + [student_utterance], st.session_state['tutor'])
                    #response = st.write_stream(output)
                    st.write(output) # bc no stream
                    response = output # bc no stream
                    print("-----------------------------------------------")
                    encoding = tiktoken.get_encoding("cl100k_base")
                    completion_tokens = 0#len(encoding.encode(response))
            ...
            # Replace characters in the response content as before
